...
const AwardsSection = () => (
  <section className="relative w-full bg-gradient-to-br from-[#0f0806] via-[#1a0f0a] to-[#2d1810] overflow-hidden py-24">
    ...
    <motion.div
      className="absolute -top-20 -left-40 w-[400px] h-[400px] bg-gradient-to-br from-[#d4af37]/20 to-transparent rounded-full blur-3xl z-0"
    ...
    <div className="relative z-10 container mx-auto px-4 md:px-20">
      ...
      >
        <span className="text-[#d4af37] text-sm font-medium tracking-[0.2em] uppercase border border-[#d4af37]/30 px-4 py-2 rounded-full backdrop-blur-sm mb-4 inline-block">
          Awards & Recognitions
        </span>
        <h2 className="text-4xl md:text-6xl font-serif font-bold text-[#f5f0e8] mb-4">
          Distinction in
          <span className="block text-transparent bg-gradient-to-r from-[#d4af37] to-[#f4d03f] bg-clip-text">
            Every Bottle
          </span>
        </h2>
      ...
      >
        {awards.map((award, i) => (
          <motion.div
            key={i}
            className="
              bg-gradient-to-b from-[#2d1810]/60 to-[#1a0f0a]/80 border border-[#d4af37]/25 rounded-2xl p-6 flex flex-col items-center text-center shadow-xl
          ...
          >
            <div className="relative xl:w-36 lg:w-32 w-24 h-24 mb-6">
              <Image
                ...
                style={{ filter: "drop-shadow(0 4px 24px #d4af3750)" }}
              />
            </div>
            <h4 className="text-[#d4af37] text-xl font-bold leading-tight mb-2">
